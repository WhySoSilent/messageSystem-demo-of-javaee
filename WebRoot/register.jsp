		...
		<div class="container">
			...
			<form class="form-horizontal" action="Register" method="post">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="realname" id="realname" class="input-xlarge" placeholder="">
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="password" name="repeat-password" id="repeat-password" class="input-xlarge">
					</div>
				</div>
